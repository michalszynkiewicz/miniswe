...
- Model-side: ~98 tok/s, no parse errors, no thinking leakage, tool calls well-formed. It simply has no move after a broken edit except re-reading the file. Same shape as the pkg read-loop (38–51 reads) but never escaping.
